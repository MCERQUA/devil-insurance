...
export function CTABand({
  ...
  return (
    <section className="relative overflow-hidden bg-[#8C1D40]">
      <div
        aria-hidden
        className="absolute inset-0 opacity-[0.07] bg-hazard-stripes"
      />
      {/* Gold glow top */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-[#FFC627]/10 rounded-full blur-3xl pointer-events-none" />
      <div className="container-x relative py-16">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 shrink-0">
            <Link
              href="/quote"
              className="inline-flex items-center gap-2 bg-[#FFC627] hover:bg-[#ffd35e] text-[#1a0a0d] font-heading font-bold uppercase tracking-tight px-8 py-4 rounded-lg transition-colors shadow-[0_0_24px_rgba(255,198,39,0.3)]"
            >
